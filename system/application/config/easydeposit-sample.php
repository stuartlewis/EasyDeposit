<?php
    ...
    $config['easydeposit_steps'] = array('nologin',
                                         'selectrepository',
                                         'servicedocument',
                                         'metadata',
                                         'uploadfiles',
    ...
    $config['easydeposit_metadata_itemtypes'] = array(
                  ...
                  'http://purl.org/eprint/type/ConferencePoster' => 'Conference poster',
                  'http://purl.org/eprint/type/Thesis' => 'Thesis or dissertation',
                  'http://purl.org/eprint/type/Book' => 'Book',
                  'http://purl.org/eprint/type/BookItem' => 'Book chapter',
                  'http://purl.org/eprint/type/BookReview' => 'Book review',
                  'http://purl.org/eprint/type/Report' => 'Report',
                  'http://purl.org/eprint/type/WorkingPapaer' => 'Working paper',
                  'http://purl.org/eprint/type/NewsItem' => 'News item',
                  'http://purl.org/eprint/type/Patent' => 'Patent',
                  'http://purl.org/eprint/type/Report' => 'Report');

    // Peer review status
    $config['easydeposit_metadata_peerreviewstatus'] = array(
                  'http://purl.org/eprint/status/PeerReviewed' => 'Yes',
                  'http://purl.org/eprint/status/NonPeerReviewed' => 'No');
